	...
	if (processStatus == null) {
		...
		if (applyReason == '') {
			...
			$.ajax({
				...
				data: {
					'doubleMajorColl': doubleMajorColl, 'doubleMajorDept': doubleMajorDept, 'applyReason': applyReason, 'stuYear': stuYear
					, 'stuSem': stuSem, 'menuCode': menuCode, 'subMenuCode': subMenuCode
				}, //필요한 데이터
